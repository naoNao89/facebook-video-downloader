...
/// Compression level selector component props
#[derive(Properties, PartialEq)]
pub struct CompressionLevelSelectorProps {
    pub original_size_mb: u64,
    pub selected_level: CompressionLevel,
    pub on_level_change: Callback<CompressionLevel>,
    pub compression_available: bool,
}

#[function_component(CompressionLevelSelector)]
pub fn compression_level_selector(props: &CompressionLevelSelectorProps) -> Html {
